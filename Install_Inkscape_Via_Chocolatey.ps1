...
$logFile = "Install-Inkscape-Log.txt"
Function Log {
...
# Install Inkscape
Try {
    Log "Starting Inkscape installation..."
    choco install inkscape -y
    Log "Inkscape installation completed successfully."
} Catch {
    Log "Error during Inkscape installation: $_"
    Log "Script terminated due to error."
    Exit 1
}
